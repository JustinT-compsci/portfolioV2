  ...
  return (
    <div className="relative overflow-hidden rounded-full bg-zinc-300/40 p-[1px] pt-[0.5px]">
      ...
      <a
        ...
        className={cn(
          'relative inline-flex items-center gap-1.5 rounded-full bg-zinc-800 px-2 py-1 text-sm text-zinc-300 transition-colors duration-200 hover:bg-[#322751] hover:text-zinc-100',
          className,
        )}
      >
