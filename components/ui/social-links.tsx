...
export function SocialLinkButton({
  ...
  return (
    ...
    <a
      ...
      className={cn(
        'relative inline-flex items-center gap-1 rounded-full border border-zinc-600 bg-zinc-800 px-2 py-1 text-sm text-zinc-300 transition-colors duration-200 hover:bg-[#322751] hover:text-zinc-100 hover:border-zinc-300',
        className
      )}
    >
